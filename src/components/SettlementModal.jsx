...
import { CheckCircle, Coins, TrendingUp, Zap, ArrowRight, Wallet, Loader2, ExternalLink, AlertCircle } from 'lucide-react';
            ...
            <div className="bg-red-500/20 border border-red-500/50 rounded-xl p-3 mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-red-400 font-cyber text-sm">
                  {error.message?.slice(0, 50) || 'Transaction failed'}
                </span>
              </div>
            </div>
          )}
